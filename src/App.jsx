...
function App() {
  return (
    <>
      ...
      <section style={{ backgroundImage: "url('/bg.jpg')" }} className="main-content bg-cover bg-center min-h-screen flex flex-col items-center justify-center pt-24"
      >
        ...
        <div className="max-w-7xl w-full mx-auto p-8 md:p-12 ">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-4">
            <div className="text-center md:text-left space-y-4 rounded-2xl bg-black/50 backdrop-blur-md shadow-[0_0_40px_rgba(156,163,175,0.35),0_25px_50px_rgba(0,0,0,0.45)] p-6">
